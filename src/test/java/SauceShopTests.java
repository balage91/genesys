...
public class SauceShopTests {
    ...
    private static final String SAUCE_URL = "https://www.saucedemo.com/inventory.html";
    private static final String LOGIN_DATA_FILE = "src/test/resources/credential.json";
